...
const MASTER_OF_FORUMS = () => {
  ...
  switch (true) {
    ...
    case ['hostloc.com', 'www.hostloc.com', '91ai.net', 'www.91ai.net', 'hostloc.me', 'www.hostloc.me', 'hostloc.pw', 'www.hostloc.pw', 'loc.umr.lol', 'mjjbbs.eu.org'].includes(HOSTNAME):
